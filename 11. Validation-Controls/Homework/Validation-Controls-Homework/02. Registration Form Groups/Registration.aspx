...
<asp:Content ID="RegistrationFormContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <asp:Button ID="CreateButton" runat="server" Text="Create" CssClass="btn btn-info" OnClick="CreateUser_Click" />
        <asp:Label ID="ResultLabel" runat="server" Visible="false" Text="Congratulations User has been created!" BackColor="YellowGreen"></asp:Label>
    </div>
</asp:Content>
